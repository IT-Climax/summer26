...
# BY THE END OF CLASS ON THE 7TH SEPT EVERY STUDENT SUPPOSED TO HAVE COMPLETE SOURCE CODE FOR THE
# -----------------------------

"""
LEARNING OBJECTIVE
Students should understand:
[What Python imports are, Variables, RGB colors, Functions, The game loop, Keyboard events, pygame.Rect, Drawing on the screen, Basic lists, Vector2]
"""
