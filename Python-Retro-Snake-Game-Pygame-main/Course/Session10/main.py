...
pygame.display.set_caption("Snake - Session 10")
...
while game_running:
    for event in pygame.event.get():
        ...
        if event.type == MOVE_SNAKE and not game_over:
            ...
            if head_x < 0 or head_x >= number_of_cells or head_y < 0 or head_y >= number_of_cells:
                game_over = True  # Stop movement when the head leaves the board.
